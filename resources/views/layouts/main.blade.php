                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="url('auth/resgister')">Registar</a>
                                </li>
                                <li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    ...
                                    <a href="{{url('/dashboard/user')}}">Registar</a>
                                </li>
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    ...
                                    <a href="{{url('/dashboard/clientes')}}">Registar</a>
                                </li>
                                
                                <li>
                                    <a href="index2.html">Ver Histórico de Pagamento</a>
                                </li>
                                <li>
                                    <a href="index3.html">Listar Devedores</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Pagamentos</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="login.html">Registar</a>
                                </li>
                                <li>
                                    <a href="forget-pass.html">Alterar</a>
                                </li>
                                <li>
                                    <a href="register.html">Aprovas Pagamento</a>
                                </li>
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>Serviços</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                               
                                <li>
                                   
                                    <a href="{{url('/dashboard/servicos')}}">Registar</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-desktop"></i>PTs</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="button.html">Registar</a>
                                </li>
        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright">
                            <p> Developed By: Try Code - <a href="https://trycode.ao/">www.trycode.ao</a> </a>.</p>
                        </div>
                    </div>
                </div>
            </div>
